...
import qlbhgg.dao.GetBillCodeDao;
...
public class PanelSale extends javax.swing.JPanel {
    ...
    public float totalPrice = 0, totalDiscount = 0;
    ...
    private void showProductsBill(ArrayList<Invoicedetails> ListBill, int countProductBill) throws SQLException {
        ...
        codeBill = GetBillCodeDao.getBillCode();
    ...
    private void initComponents() {
        ...
        jLabelBillcode.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jComboBoxCustomer.setBackground(new java.awt.Color(255, 255, 255));
        jComboBoxCustomer.setEditable(true);
        jComboBoxCustomer.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jComboBoxCustomer.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jComboBoxCustomer.setOpaque(true);
        ...
        jComboBoxStaff.setBackground(new java.awt.Color(255, 255, 255));
        jComboBoxStaff.setEditable(true);
        jComboBoxStaff.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jComboBoxStaff.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabelEmailCustomer.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabelAddCustomer.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelAddCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/Icon/icons8_add_new_25px_1.png"))); // NOI18N
        jLabelAddCustomer.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jLabelAddCustomer.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabelAddCustomerMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jLabelAddCustomerMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jLabelAddCustomerMouseExited(evt);
            }
        });
        jPanelPay.add(jLabelAddCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 200, 30, 30));
    ...
    private void jLabelAddCustomerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelAddCustomerMouseClicked
        
    }//GEN-LAST:event_jLabelAddCustomerMouseClicked

    private void jLabelAddCustomerMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelAddCustomerMouseEntered
        jLabelAddCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/icons8_add_new_25px.png")));
    }//GEN-LAST:event_jLabelAddCustomerMouseEntered

    private void jLabelAddCustomerMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelAddCustomerMouseExited
        jLabelAddCustomer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/icons8_add_new_25px_1.png")));
    }//GEN-LAST:event_jLabelAddCustomerMouseExited
    ...
    private void jTextFieldCustomerPayKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCustomerPayKeyReleased
        float excessCash = Float.parseFloat(jLabelCustomerNeedPay.getText().replace(",", "")) - Float.parseFloat(jTextFieldCustomerPay.getText().replace(",", ""));
